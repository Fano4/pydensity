            ...
            for(int kp=0;kp!=n_closed+n_occ;kp++)
            {
               ...
               for(int m=0;m!=ci_size_neut;m++)
               {
                  for(int n=0;n!=ci_size_neut;n++)
                  {
                     ...
                     det_val=build_reduced_determinant(k,kp,n_elec_neut,n_closed,n_occ,&ci_vec_neut[(n_elec_neut+n_states_neut)*m],&ci_vec_neut[(n_elec_neut+n_states_neut)*n],&ci_vec_neut[1][n_elec_neut*m],&ci_vec_neut[1][n_elec_neut*n]);
                     ...
                     tran_den_mat_mo[i*n_states_neut*(n_occ+n_closed)*(n_occ+n_closed)+j*(n_occ+n_closed)*(n_occ+n_closed)+k*(n_occ+n_closed)+kp]+=ci_vec_neut[(n_elec_neut+n_states_neut)*(m)+n_elec_neut+i]*ci_vec_neut[(n_elec_neut+n_states_neut)*(n)+n_elec_neut+j]*det_val;
                   }
                 }
               if(k==kp)
               {
